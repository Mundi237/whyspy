...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(quality) => "压缩质量已设置为 ${quality}。提交时将压缩视频。";

  static String m1(error) => "处理媒体时出错：${error}";

  static String m2(count) => "${count} 参与者";

  static String m3(seconds) => "${seconds} 秒后重新发送";

  static String m4(phone) => "我们已发送6位数验证码到 ${phone}";

  static String m5(message) => "验证失败：${message}";

  static String m6(fileName, error) => "${fileName} 视频压缩失败：${error}";
