...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(error) => "Lỗi xử lý media: ${error}";

  static String m2(count) => "${count} người tham gia";

  static String m3(seconds) => "Gửi lại sau ${seconds} giây";

  static String m4(phone) => "Chúng tôi đã gửi mã 6 chữ số đến ${phone}";

  static String m5(message) => "Xác minh thất bại: ${message}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "acceptCallsFromUsers": MessageLookupByLibrary.simpleMessage(
      "Chấp nhận cuộc gọi từ người dùng",
    ),
    ...
    "codePage": MessageLookupByLibrary.simpleMessage("Trang mã"),
    ...
    "syncContacts": MessageLookupByLibrary.simpleMessage("Đồng bộ hóa danh bạ"),
