...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(error) => "मीडिया प्रोसेसिंग त्रुटि: ${error}";

  static String m2(count) => "${count} प्रतिभागी";

  static String m3(seconds) => "${seconds} सेकंड में पुनः भेजें";

  static String m4(phone) => "हमने ${phone} पर 6 अंकों का कोड भेजा है";

  static String m5(message) => "सत्यापन विफल: ${message}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "acceptCallsFromUsers": MessageLookupByLibrary.simpleMessage(
      "उपयोगकर्ताओं से कॉल स्वीकार करें",
    ),
    ...
    "codePage": MessageLookupByLibrary.simpleMessage("कोड पृष्ठ"),
    ...
    "syncContacts": MessageLookupByLibrary.simpleMessage("संपर्क सिंक करें"),
