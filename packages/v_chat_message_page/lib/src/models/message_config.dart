...
class VMessageConfig {
  ...
  /// callback when user selects an emoji reaction from the quick reaction bar
  final void Function(VBaseMessage baseMessage, String emoji)?
  ...
  const VMessageConfig({
    ...
    this.onMessageReactionSelected,
